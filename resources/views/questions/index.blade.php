                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex items-center mb-6 space-x-2">
                        <a href="{{ route('questions.create') }}"
                            class="inline-flex items-center px-4 py-2 bg-gray-800 text-white border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 transition ease-in-out duration-150">
                            Buat Pertanyaan Baru
                        </a>

                        <a href="{{ route('questions.export') }}"
                            style="background:#10B981; color:white; padding:10px 20px; border-radius:6px; display:inline-block; font-weight:bold; margin-left:8px;">
                            Export Pertanyaan (CSV)
                        </a>
                    </div>
